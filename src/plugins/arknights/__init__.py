...
async def terminology_func(message: Message = CommandArg()):
    ...
    term_name_to_description = {term.term_name: escape_description(term.description)
    ...
    for term_name in term_name_list:
        ...
        lines.append("")
        term_discription = term_name_to_description.get(term_name, f"未找到术语 {term_name} 的释义")
        lines.append(term_discription)
    lines.append("")
    lines.append("________________")
    lines.append("# Generated by BioBot")
    lines.append("# Made by bilibili@Bio-Hazard")
