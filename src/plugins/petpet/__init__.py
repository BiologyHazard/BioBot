...
help_cmd = on_command("头像表情包", aliases={"头像相关表情包", "头像相关表情制作"}, block=False, priority=12)
block_cmd = on_command("禁用表情", block=False, priority=12, permission=PERM_EDIT)
unblock_cmd = on_command("启用表情", block=False, priority=12, permission=PERM_EDIT)
block_cmd_gl = on_command("全局禁用表情", block=False, priority=12, permission=PERM_GLOBAL)
unblock_cmd_gl = on_command("全局启用表情", block=False, priority=12, permission=PERM_GLOBAL)
