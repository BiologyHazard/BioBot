...
fontpath = str(plugin_config.data_path / 'fonts/SourceHanMonoSC-Regular.otf')
...
def text_to_image(text: str, fontpath=fontpath, fontsize: int = 24) -> PILImage:
    font: FreeTypeFont = ImageFont.truetype(fontpath, fontsize)
    padding: int = 10
    margin: int = 4
