...
class DrawBest(object):
    ...
    def __init__(self, sdBest: BestList, dxBest: BestList, userName: str):
        ...
        self.pic_dir = 'data/maimai/mai/pic/'
        self.cover_dir = 'data/maimai/mai/cover/'
        self.img = Image.open(
    ...
    def _getCharWidth(self, o) -> int:
        widths = [
            ...
            (8426, 0), (9000, 1), (9002, 2), (11021, 1),
            (12350, 2), (12351, 1), (12438, 2), (12442, 0),
            (19893, 2), (19967, 1), (55203, 2), (63743, 1),
            (64106, 2), (65039, 1), (65059, 0), (65131, 2),
            (65279, 1), (65376, 2), (65500, 1), (65510, 2),
    ...
    def _drawBestList(self, img: Image.Image, sdBest: BestList, dxBest: BestList):
        ...
        titleFontName = 'data/maimai/adobe_simhei.otf'
        for num in range(0, len(sdBest)):
            ...
            font = ImageFont.truetype(
                'data/maimai/adobe_simhei.otf', 12, encoding='utf-8')
            tempDraw.text(
                (8, 44), f'Base: {chartInfo.ds} -> {computeRa(chartInfo.ds, chartInfo.achievement)}', 'white', font)
            font = ImageFont.truetype(
                'data/maimai/adobe_simhei.otf', 18, encoding='utf-8')
    ...
    def draw(self):
        ...
        font1 = ImageFont.truetype('data/maimai/msyh.ttc', 28, encoding='unic')
        ...
        font2 = ImageFont.truetype(
            'data/maimai/adobe_simhei.otf', 14, encoding='utf-8')
