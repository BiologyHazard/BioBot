...
PLATE_TO_VERSION: dict[str, list[str]] = {
    ...
    '霸': ['maimai', 'maimai PLUS', 'maimai GreeN',
          ...
          'maimai FiNALE'],
    '熊': ['maimai でらっくす'],
    '華': ['maimai でらっくす', 'maimai でらっくす PLUS'],
    '华': ['maimai でらっくす', 'maimai でらっくす PLUS'],
    '爽': ['maimai でらっくす Splash'],
    '煌': ['maimai でらっくす Splash', 'maimai でらっくす Splash PLUS'],
    '宙': ['maimai でらっくす UNiVERSE'],
    '星': ['maimai でらっくす UNiVERSE', 'maimai でらっくす UNiVERSE PLUS'],
