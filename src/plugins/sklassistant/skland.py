...
class SKLand:
    ...
    async def _request(self,
        ...
        if raise_error:
            if (isinstance(obj, dict)
                and ('status' in obj and obj['status'] != 0
    ...
    async def send_phone_code(self, phone: str) -> None:
        ...
        await self._request('POST', send_phone_code_url, login_headers, data, sign=False)
    ...
    async def token_by_phone_code(self, phone: str, code: str) -> str:
        ...
        obj = await self._request('POST', token_by_phone_code_url, login_headers, data, sign=False)
    ...
    async def token_by_phone_password(self, phone: str, password: str) -> str:
        ...
        obj = await self._request('POST', token_by_phone_password_url, login_headers, data, sign=False)
    ...
    async def attendance(self, uid: str, channel_master_id: str = "1") -> dict[str, Any]:
        data = {
...
async def attendance_and_send_email(token: str,
